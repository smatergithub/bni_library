      ...
      >
        ...
        <div className="mt-2">
          ...
          <input
            name="pengarang"
            disabled={true}
            defaultValue={detailData.user ? detailData.user.name : 'Tidak Ada Peminjam'}
            className="w-full px-5  py-1 text-gray-700 bg-gray-100 rounded outline-none focus:shadow-outline "
            type="text"
            aria-label="Email"
          />
        ...
        {detailData.user ? <React.Fragment>
          ...
          <div className="mt-2">
            ...
            <input
              name="pengarang"
              disabled={true}
              defaultValue={detailData.transactionEbook ? detailData.transactionEbook.startDate : 'Tidak Ada Peminjam'}
              className="w-full px-5  py-1 text-gray-700 bg-gray-100 rounded outline-none focus:shadow-outline "
              type="text"
              aria-label="Email"
            />
          ...
          <div className="mt-2">
            ...
            <input
              name="pengarang"
              disabled={true}
              defaultValue={detailData.transactionEbook ? detailData.transactionEbook.endDate : 'Tidak Ada Peminjam'}
              className="w-full px-5  py-1 text-gray-700 bg-gray-100 rounded outline-none focus:shadow-outline "
              type="text"
              aria-label="Email"
            />
