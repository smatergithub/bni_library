...
const NotFound = () => {
  return (
    <div className="pt-40 ">
      <div className="flex  lg:w-full md:w-3/5 justify-center items-start text-center md:text-left ">
        <div class="container mx-auto px-4">
          <section class="py-8 px-4 text-center">
            <div class="max-w-auto mx-auto">
              ...
              <p class="mt-6 uppercase text-sm lg:text-base text-gray-900">
                The page you are looking for might have been removed had its name changed or is
                temporarily unavailable.
              </p>
              <a
                href="/"
                class="mt-6 bg-orange-500 hover:bg-orange-400 text-white font-light py-2 px-6 rounded-lg inline-block uppercase shadow-md"
              >
                Back To Homepage
              </a>
            </div>
