...
import { Modal, ToastError } from '../../../../component';
import { getBookById } from '../../../../redux/action/bookUser';
import { orderBook } from '../../../../redux/action/transaction';
let img =
...
export default withRouter(connect(null, { getBookById, orderBook })(OrderBook));
