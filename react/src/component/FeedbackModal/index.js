...
export default function Modal(props) {
  const { open, title, handleSubmit, listBorrowBook, listborrowEbook } = props;
  ...
  let data123 =
    listBorrowBook.length > 0 ? listBorrowBook.filter(item => item.isGiveRating === false) : null;

  console.log('adasdasd', data123);
